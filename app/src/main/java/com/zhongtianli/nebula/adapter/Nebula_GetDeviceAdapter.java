...
public class Nebula_GetDeviceAdapter extends  RecyclerView.Adapter<Nebula_GetDeviceAdapter.ViewHolder>
{
...
private List<String> projectNames = new ArrayList<>();
    ...
    public Nebula_GetDeviceAdapter(Context context, List<String> projectNames){
